...
// for linear algebra.
//
// Copyright (C) 2008-2015 Gael Guennebaud <REMOVED_EMAIL>
// Copyright (C) 2008-2009 Benoit Jacob <REMOVED_EMAIL>
// Copyright (C) 2009 Kenneth Riddile <REMOVED_EMAIL>
// Copyright (C) 2010 Hauke Heibel <REMOVED_EMAIL>
// Copyright (C) 2010 Thomas Capricelli <REMOVED_EMAIL>
// Copyright (C) 2013 Pavel Holoborodko <REMOVED_EMAIL>
//
